...
class MultiPatternTree:
    ...
    def __init__(self, tree_plans, patterns: List[Pattern], storage_params: TreeStorageParameters,
        ...
        self.__output_nodes = self.__construct_multi_pattern_tree(tree_plans, patterns, storage_params,
    ...
    def get_matches(self):
        ...
        for output_node in self.__output_nodes:
            while output_node.has_unreported_matches():
                match = output_node.get_last_unreported_match()
                pattern_idx = output_node.get_pattern_ids()
                for idx in pattern_idx:
                    if self.__pattern_to_output_node_dict[idx] != output_node:
