...
class NegationNode(BinaryNode, ABC):
    ...
    """
    def __init__(self, tree_plan_node: TreePlanNode, pattern_params: PatternParameters, is_unbounded: bool, top_operator: Type,
                 parents: List[Node] = None, pattern_ids: int or Set[int] = None,
                 event_defs: List[PrimitiveEventDefinition] = None,
                 left: Node = None, right: Node = None):
        super().__init__(tree_plan_node, pattern_params, parents, pattern_ids, event_defs, left, right)
...
class NegativeAndNode(NegationNode):
    ...
    """
    def __init__(self, tree_plan_node: TreePlanNode, pattern_params: PatternParameters, is_unbounded: bool,
                 parents: List[Node] = None, pattern_ids: int or Set[int] = None,
                 event_defs: List[PrimitiveEventDefinition] = None,
                 left: Node = None, right: Node = None):
        super().__init__(tree_plan_node, pattern_params, is_unbounded, AndOperator, parents, pattern_ids, event_defs, left, right)
        self.set_condition(tree_plan_node.condition) # new
...
class NegativeSeqNode(NegationNode):
    ...
    def __init__(self, tree_plan_node: TreePlanNode, pattern_params: PatternParameters, is_unbounded: bool,
                 ...
                 event_defs: List[PrimitiveEventDefinition] = None,
                 left: Node = None, right: Node = None):
        super().__init__(tree_plan_node, pattern_params, is_unbounded, SeqOperator, parents, pattern_ids, event_defs, left, right)
        self.set_condition(tree_plan_node.condition) # new
