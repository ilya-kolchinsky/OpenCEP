...
class StateNode:
    ...
    def get_neighbors(self):
        while True:
            ...
            # case:
            # patter_a, pattern_b yield the same subpattern as pattern_c, pattern_d
            ...
            if (patterns_set, filtered_events) != self.__last_used:
                break

        self.__last_used = patterns_set, filtered_events
