...
from parallerization.tree_implemintation.WorkloadFrameworkForSingleEvent import WorkloadFrameworkForSingleEventTests
...
def SingleStructureMultiData4(createTestFile=False):
    ...
    workload = WorkloadFrameworkForSingleEventTests(pattern, execution_units=1, is_data_parallel=True,
                                                 is_structure_parallel=False, num_of_families=0)
    print("Running test for single structure, multiple data parts with 1 structure, 1 data part")
...
def SingleStructureMultiData2(createTestFile=False):
    ...
    workload = WorkloadFrameworkForSingleEventTests(pattern, execution_units=3, is_data_parallel=True,
                                                 is_structure_parallel=False, num_of_families=0)
...
def SingleStructureMultiData3(createTestFile=False):
    ...
    workload = WorkloadFrameworkForSingleEventTests(pattern, execution_units=5, is_data_parallel=True,
                                                 is_structure_parallel=False, num_of_families=0)
...
def MultipleStructuresSingleData7(createTestFile=False):
    ...
    workload_framework = ParallelTreeWorkloadFramework(pattern, execution_units=1,
                                                       is_data_parallel=False,
                                                       is_structure_parallel=True, num_of_families=0)
...
def MultipleStructuresSingleData8(createTestFile=False):
    ...
    workload_framework = ParallelTreeWorkloadFramework(pattern, execution_units=3,
                                                       is_data_parallel=False,
                                                       is_structure_parallel=True, num_of_families=0)
...
def MultipleStructuresSingleData9(createTestFile=False):
    ...
    workload_framework = ParallelTreeWorkloadFramework(pattern, execution_units=7,
                                                       is_data_parallel=False,
                                                       is_structure_parallel=True, num_of_families=0)
