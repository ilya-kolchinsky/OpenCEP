...
def dpLdNestedPatternSearchTest(createTestFile=False):
    ...
    runTest('dpLd1nested', [pattern], createTestFile, eval_mechanism_params=eval_params, events=nasdaqEventStream)
...
def dpLdNestedPatternComplexSearchTest(createTestFile=False):
    ...
    runTest('dpLd1nestedComplex', [pattern], createTestFile, eval_mechanism_params=eval_params, events=nasdaqEventStream)
...
def zStreamOrdNestedPatternComplexSearchTest(createTestFile=False):
    ...
    runTest('zstream-ord1NestedComlex', [pattern], createTestFile, eval_mechanism_params=eval_params, events=nasdaqEventStream)

def KC_AND_IndexCondition_02_Nested(createTestFile=False):
    pattern = Pattern(
    ...
    runStructuralTest('structuralTest2', [pattern], expected_result)
    # runTest("KC_AND_IndexCondition_02_Nested", [pattern], createTestFile, events=nasdaqEventStreamKC)
