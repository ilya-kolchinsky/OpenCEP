...
def pattern_transformation(pattern: Pattern,
    ...
    """
    Method receives a single pattern and transforms it to a list of patterns according to the enabled rules.
    """
    transformed_pattern_structures_list = [pattern.full_structure.duplicate()]
    rules_directive = rule_transformation_params.rules_directive.copy()

    for rule_name in rules_directive:
        ...
        elif rule_name == RuleTransformationTypes.SEQ_OR_PATTERN:
            transformed_pattern_structures_list = transform_seq_or(transformed_pattern_structures_list)
        elif rule_name == RuleTransformationTypes.SEQ_NOT_AND_PATTERN:
    ...
    for transformed_pattern_structure in transformed_pattern_structures_list:
        pattern_list.append(Pattern(transformed_pattern_structure, pattern.condition,
